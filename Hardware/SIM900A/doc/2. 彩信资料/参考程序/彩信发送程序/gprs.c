...
// 作用:	初始化用于连接gps的串口1
,将串口1设置位独立波特率发生器提供波特率， 并打开串口1中断和全局中断
// 参数:	smod	smod位	0/1
                        brtx12	brtx12位  0/1
                        reload	reload寄存器数值  0-255
...
// 作用:
接收gps模块传来的定位信号，并将GPRMC信息中的各种信息存入gprmc结构体内，详见gprmc结构体
// 参数:	void
// 返回:	void
////////////////////////////////////////////////////////////////////////////////////////////////////*/
...
// 作用:  串口2的中断函数，用于保存接收到的gprs传来的数据，
                        当
GprsFlagInfoAble=1，时说明当前保存到gprs_dat_recv[0]-gprs_dat_recv[GprsRecvCntAt]中存放的是一个完整的at回复指令，
                        必须马上读出出来，否则下一个数据到来后该指令将被取代。
                         GprsFlagInfoStart
在接收信息时该位置1，接收完一组完整at回复指令清0
// 参数:  void
// 返回:  void
////////////////////////////////////////////////////////////////////////////////////////////////////*/
