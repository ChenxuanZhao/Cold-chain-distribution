...
sfr PSW = 0xd0;  //程序状态字            Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 位描述                CY      AC      F0
                 //RS1     RS0     OV      F1      P 初始值=0000,0000      0 0
                 //0       0       0       0       0       0
...
sfr ACC = 0xe0;  //累加器                Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0
...
sfr B = 0xf0;  // B寄存器               Bit7    Bit6    Bit5    Bit4    Bit3
               // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0 0
               //0       0       0       0

/////////////////////////////////

sfr SP = 0x81;  //堆栈指针              Bit7    Bit6    Bit5    Bit4    Bit3
                //Bit2    Bit1    Bit0 初始值=0000,0111      0       0       0
                //0       0       1       1       1

/////////////////////////////////

sfr DPL = 0x82;  //数据指针低字节        Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0

/////////////////////////////////

sfr DPH = 0x83;  //数据指针高字节        Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0

////////////////////////////////////////////////////////////////////////////////////////////////////////////////

sfr PCON = 0x87;  //电源控制寄存器        Bit7    Bit6    Bit5    Bit4    Bit3
                  //Bit2    Bit1    Bit0 位描述                SMOD    SMOD0
                  //LVDF    POF     GF1     GF0     PD      IDL 初始值=0011,0000
                  //0       0       1       1       0       0       0       0
...
sfr WAKE_CLKO =
    0x8f;  //掉电唤醒/时钟输出控制 Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           //Bit1    Bit0 位描述          PCAWAKEUP RXDPINIE T1PINIE T0PINIE
           //LVD_WAKEUP BRTCLKO T1VLKO  T0CLKO 初始值=0000,0000      0       0
           //0       0       0       0       0       0

#define PCAWAKEUP 0x80  //允许PCA的上升沿/下降沿中断唤醒掉电MCU
#define RXD_PIN_IE \
  0x40  //允许RXD(P3.0)下降沿置位RI中断时唤醒掉电MCU(必须打开相应中断)
#define T1_PIN_IE \
  0x20  //允许T1(P3.5)下降沿置位T1中断时唤醒掉电MCU(必须打开相应中断)
#define T0_PIN_IE \
  0x10  //允许T0(P3.4)下降沿置位T0中断时唤醒掉电MCU(必须打开相应中断)
#define LVD_WAKEUP \
  0x08  //允许LVD(P4.6)的低压检测中断唤醒掉电MCU(必须打开相应中断)
#define BRTCLKOEN \
  0x04  //打开P1.0脚的BRT时钟溢出脉冲,输出的时钟频率为1/2倍的BRT溢出率
#define T1CLKOEN \
  0x02  //打开P3.5脚的定时器1时钟溢出脉冲,输出的时钟频率为1/2倍的T1溢出率
#define T0CLKOEN \
  0x01  //打开P3.4脚的定时器0时钟溢出脉冲,输出的时钟频率为1/2倍的T0溢出率

/////////////////////////////////

sfr CLK_DIV = 0x97;  //时钟分频寄存器        Bit7    Bit6    Bit5    Bit4 Bit3
                     //Bit2    Bit1    Bit0 位描述                -       - - -
                     //-       CLKS2   CLKS1   CLKS0 初始值=xxxx,x000      x x
                     //x       x       x       0       0       0
...
sfr BUS_SPEED =
    0xa1;  //数据总线速度控制器    Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           //Bit1    Bit0 位描述                -       -       ALES1   ALES0 -
           //RWS2    RWS1    RWS0 初始值=xx10,x011      x       x       1 0 x 0
           //1       1

#define ALES1 0x20  // P0地址建立时间和保持时间到ALE信号的下降沿的时钟数
#define ALES0 \
  0x10  // ALES1/ALES0=0/0:1个时钟 0/1:2个时钟 1/0:3个时钟 1/1:4个时钟

#define RWS2 0x04  // MOVX指令的时钟数
#define RWS1 \
  0x02  // RWS2/RWS1/RWS0=000:1个时钟 001:2个时钟 010:3个时钟 011:4个时钟
#define RWS0 \
  0x01  //               100:5个时钟 101:6个时钟 110:7个时钟 111:8个时钟

/////////////////////////////////

sfr WDT_CONTR =
    0xc1;  //看门狗定时器控制器    Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           //Bit1    Bit0 位描述             WDT_FLAG   -       EN_WDT  CLR_WDT
           //IDL_WDT PS2     PS1     PS0 初始值=0x00,0000      0       x       0
           //0       0       0       0       0

#define WDT_FLAG \
  0x80  //看门狗复位标志,当看门狗溢出产生复位后,硬件自动置1,需要由软件清0
...
sfr AUXR =
    0x8e;  //辅助寄存器            Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           //Bit1    Bit0 位描述                T0x12   T1x12   UM0x6   BRTR
           //S2SMOD  BRTx12  EXTRAM  S1BRS 初始值=0000,0000      0       0 0 0
           //0       0       0       0

#define T0x12 \
  0x80  //定时器0时钟控制,0:Fosc/12(传统的12分频)
        //1:Fosc/1(1T模式,不分频,即12倍于传统速度)
#define T1x12 \
  0x40  //定时器1时钟控制,0:Fosc/12(传统的12分频)
        //1:Fosc/1(1T模式,不分频,即12倍于传统速度)
#define UR0x6 \
  0x20  //串口模式0的时钟控制,0:Fosc/12(传统的12分频)
        //1:Fosc/2(2分频,,即6倍于传统速度)
#define BRTR \
  0x10  //独立波特率发生器启动控制位,1:启动独立波特率发生器
        //0:停止独立波特率发生器
#define S2SMOD 0x08  //串口2波特率倍速位,置1可使串口2的波特率快1倍
#define BRTx12 \
  0x04  //独立波特率发生器时钟控制,0:Fosc/12(传统的12分频)
        //1:Fosc/1(1T模式,不分频,即12倍于传统速度)
#define EXTRAM 0x02  //内部扩展RAM禁能位,0:内部扩展RAM有效 1:禁用内部扩展RAM
#define S1BRS \
  0x01  //串口1的波特率发生器选择位,0:定时器1
        //1:独立波特率发生器(注意串口2只能够使用独立波特率发生器)

/////////////////////////////////

sfr AUXR1 =
    0xa2;  //辅助寄存器1           Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           //Bit1    Bit0 位描述                -       PCA_P4  SPI_P4  S2_P4
           //GF2     ADRJ    -       DPS 初始值=x000,00x0      x       0       0
           //0       0       0       x       0

#define PCA_P4 \
  0x40  //将PCA口映射到P4口,0:ECI(P1.2)CEX0(P1.3)CEX1(P1.4)
        //1:ECI(P4.1)CEX0(P4.2)CEX1(P4.3)
#define SPI_P4 \
  0x20  //将SPI口映射到P4口,0:SCLK(P1.7)MISO(P1.6)MOSI(P1.5)SS(P1.4)
        //1:SCLK(P4.3)MISO(P4.2)MOSI(P4.1)SS(P4.0)
#define S2_P4 \
  0x10  //将串口2映射到P4口,0:RXD2(P1.2)TXD2(P1.3) 1:RXD2(P4.2)TXD2(P4.3)
#define GF2 0x08  //通用标志位2
#define ADRJ \
  0x04  // ADC结果调整,0:{ADC_RES[9876,5432],ADC_RESL[----,--10]}
        // 1:{ADC_RES[----,--98],ADC_RESL[7654,3210]}
#define DPS 0x01  // DPTR0/DPTR1选择位,0:DPTR0 1:DPTR1

////////////////////////////////////////////////////////////////////////////////////////////////////////////////

sfr P0 = 0x80;  // I/O端口0              Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 位描述                P0.7    P0.6 P0.5
                //P0.4    P0.3    P0.2    P0.1    P0.0 初始值=1111,1111      1
                //1       1       1       1       1       1       1
...
sfr P1 = 0x90;  // I/O端口0              Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 位描述                P1.7    P1.6 P1.5
                //P1.4    P1.3    P1.2    P1.1    P1.0 初始值=1111,1111      1
                //1       1       1       1       1       1       1
...
sfr P2 = 0xa0;  // I/O端口2              Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 位描述                P2.7    P2.6 P2.5
                //P2.4    P2.3    P2.2    P2.1    P2.0 初始值=1111,1111      1
                //1       1       1       1       1       1       1
...
sfr P3 = 0xb0;  // I/O端口3              Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 位描述                P3.7    P3.6 P3.5
                //P3.4    P3.3    P3.2    P3.1    P3.0 初始值=1111,1111      1
                //1       1       1       1       1       1       1
...
sfr P4 = 0xc0;  // I/O端口4              Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 位描述                P4.7    P4.6 P4.5
                //P4.4    P4.3    P4.2    P4.1    P4.0 初始值=1111,1111      1
                //1       1       1       1       1       1       1
...
sfr P5 = 0xc8;  // I/O端口5              Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 位描述                -       -       -
                //-       P5.3    P5.2    P5.1    P5.0 初始值=xxxx,1111      x
                //x       x       x       1       1       1       1
...
sfr P1M1 = 0x91;  // I/O口1模式控制器1     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初/始值=0000,0000     0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P1M0 = 0x92;  // I/O口1模式控制器0     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P0M1 = 0x93;  // I/O口0模式控制器1     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P0M0 = 0x94;  // I/O口0模式控制器0     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P2M1 = 0x95;  // I/O口2模式控制器1     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P2M0 = 0x96;  // I/O口2模式控制器0     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P3M1 = 0xb1;  // I/O口3模式控制器1     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初/始值=0000,0000     0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P3M0 = 0xb2;  // I/O口3模式控制器0     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P4M1 = 0xb3;  // I/O口4模式控制器1     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P4M0 = 0xb4;  // I/O口4模式控制器0     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                  //0       0       0       0       0

/////////////////////////////////

sfr P5M1 = 0xc9;  // I/O口5模式控制器1     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=xxxx,0000      x       x       x
                  //x       0       0       0       0

/////////////////////////////////

sfr P5M0 = 0xca;  // I/O口5模式控制器0     Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 初始值=xxxx,0000      x       x       x
                  //x       0       0       0       0
...
sfr P1ASF =
    0x9d;  // P1口模拟功能控制位    Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           // Bit1    Bit0 位描述                P17ASF  P16ASF  P15ASF  P14ASF
           //P13ASF  P12ASF  P11ASF  P10ASF 初始值=0000,0000      0       0 0 0
           //0       0       0       0
...
sfr P4SW = 0xbb;  // P4口的功能开关        Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 位描述                -    LVD_P4.6
                  //ALE_P4.5 NA_P4.4  -       -       -       - 初始值=x000,xxxx
                  //x       0       0       0       x       x       x       x
...
sfr IE = 0xa8;  //中断使能寄存器        Bit7    Bit6    Bit5    Bit4    Bit3
                //Bit2    Bit1    Bit0 位描述                EA      ELVD EADC
                //ES      ET1     EX1     ET0     EX0 初始值=0000,0000      0 0
                //0       0       0       0       0       0
...
sfr IE2 = 0xaf;  //中断使能寄存器2       Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 位描述                -       -       -
                 //-       -       -       ESPI    ES2 初始值=xxxx,xx00      x
                 //x       x       x       x       x       0       0
...
sfr IP2 = 0xb5;  //中断优先级寄存器2     Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 位描述                -       -       -
                 //-       -       -       PSPI    PS2 初始值=xxxx,xx00      x
                 //x       x       x       x       x       0       0
...
sfr IP2H = 0xb6;  //中断优先级寄存器2高位 Bit7    Bit6    Bit5    Bit4    Bit3
                  //Bit2    Bit1    Bit0 位描述                -       -       -
                  //-       -       -       PSPIH   PS2H 初始值=xxxx,xx00      x
                  //x       x       x       x       x       0       0
...
sfr IPH = 0xb7;  //中断优先级寄存器高位  Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 位描述                PPCAH   PLVDH
                 //PADCH   PSH     PT1H    PX1H    PT0H    PX0H 初始值=0000,0000
                 //0       0       0       0       0       0       0       0
...
sfr IP = 0xb8;  //中断优先级寄存器      Bit7    Bit6    Bit5    Bit4    Bit3
                //Bit2    Bit1    Bit0 位描述                PPCA    PLVD PADC
                //PS      PT1     PX1     PT0     PX0 初始值=0000,0000      0 0
                //0       0       0       0       0       0
...
sfr TCON = 0x88;  //定时器0/1控制寄存器   Bit7    Bit6    Bit5    Bit4    Bit3
                  //Bit2    Bit1    Bit0 位描述                TF1     TR1 TF0
                  //TR0     IE1     IT1     IE0     IT0 初始值=0000,0000      0
                  //0       0       0       0       0       0       0

sbit TF1 =
    TCON ^
    7;  //定时器1溢出标志,由硬件置1,可由软件清0或者在中断处理程序完成后由硬件自动清0
sbit TR1 = TCON ^ 6;  //定时器1的启动控制位,1:启动定时器 0:停止定时器
sbit TF0 =
    TCON ^
    5;  //定时器0溢出标志,由硬件置1,可由软件清0或者在中断处理程序完成后由硬件自动清0
sbit TR0 = TCON ^ 4;  //定时器0的启动控制位,1:启动定时器 0:停止定时器
sbit IE1 =
    TCON ^
    3;  //外部中断1的中断请求位,由硬件置1,可由软件清0或者在中断处理程序完成后由硬件自动清0
sbit IT1 =
    TCON ^ 2;  //外部中断1的触发类型,0:低电平触发外部中断 1:下降沿触发外部中断
sbit IE0 =
    TCON ^
    1;  //外部中断0的中断请求位,由硬件置1,可由软件清0或者在中断处理程序完成后由硬件自动清0
sbit IT0 =
    TCON ^ 0;  //外部中断0的触发类型,0:低电平触发外部中断 1:下降沿触发外部中断

/////////////////////////////////

sfr TMOD = 0x89;  //定时器0/1模式寄存器   Bit7    Bit6    Bit5    Bit4    Bit3
                  //Bit2    Bit1    Bit0 位描述                GATE    C/T# M1
                  //M0      GATE    C/T#    M1      M0 初始值=0000,0000      0
                  //0       0       0       0       0       0       0

#define GATE1 \
  0x80  //定时器1启动控制位,0:TR1为1时启动定时器1
        //1:TR1为1且INT1为高电平时才启动定时器1
#define C_T1 \
  0x40  //定时器/计数器选择位,0:定时器(时钟源为内部时钟)
        //1:计数器(时钟源为T1引脚的外部时钟)
...
#define GATE0 \
  0x08  //定时器1启动控制位,0:TR0为1时启动定时器1
        //1:TR0为1且INT0为高电平时才启动定时器0
#define C_T0 \
  0x04  //定时器/计数器选择位,0:定时器(时钟源为内部时钟)
        //1:计数器(时钟源为T0引脚的外部时钟)
...
sfr TL0 = 0x8a;  //定时器0的低8位计数值  Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0

/////////////////////////////////

sfr TL1 = 0x8b;  //定时器1的低8位计数值  Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0

/////////////////////////////////

sfr TH0 = 0x8c;  //定时器0的高8位计数值  Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0

/////////////////////////////////

sfr TH1 = 0x8d;  //定时器1的高8位计数值  Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0

////////////////////////////////////////////////////////////////////////////////////////////////////////////////

sfr SCON = 0x98;  //串口控制寄存器        Bit7    Bit6    Bit5    Bit4    Bit3
                  //Bit2    Bit1    Bit0 位描述                SM0/FE  SM1 SM2
                  //REN     TB8     RB8     TI      Ri 初始值=0000,0000      0
                  //0       0       0       0       0       0       0

sbit FE =
    SCON ^
    7;  //帧错误检测位,当串口模块在接收数据时没有检测到正确的停止位时,FE被硬件置1,需要由软件来清0(当SMOD0为1时,FE有效)
sbit SM0 = SCON ^ 7;  //串口模式设置位
sbit SM1 = SCON ^ 6;  // SM0/SM1=0/0:移位寄存器 0/1:8位可变波特率
                      // 1/0:9位固定波特率 1/1:9位可变波特率
...
sfr SBUF = 0x99;  //串口接收/发送数据     Bit7    Bit6    Bit5    Bit4    Bit3
                  //Bit2    Bit1    Bit0 初始值=xxxx,xxxx      x       x       x
                  //x       x       x       x       x

/////////////////////////////////

sfr S2CON = 0x9a;  //串口2控制寄存器       Bit7    Bit6    Bit5    Bit4    Bit3
                   //Bit2    Bit1    Bit0 位描述                SM0/FE  SM1 SM2
                   //REN     TB8     RB8     TI      Ri 初始值=0000,0000      0
                   //0       0       0       0       0       0       0
...
#define S2SM1 \
  0x40  // SM0/SM1=0/0:移位寄存器 0/1:8位可变波特率 1/0:9位固定波特率
        // 1/1:9位可变波特率
...
sfr S2BUF = 0x9b;  //串口2接收/发送数据    Bit7    Bit6    Bit5    Bit4    Bit3
                   //Bit2    Bit1    Bit0 初始值=xxxx,xxxx      x       x x x x
                   //x       x       x

/////////////////////////////////

sfr SADDR = 0xa9;  //串口设备从地址寄存器  Bit7    Bit6    Bit5    Bit4    Bit3
                   //Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0 0
                   //0       0       0

/////////////////////////////////

sfr SADEN = 0xb9;  //串口设备从地址屏蔽位  Bit7    Bit6    Bit5    Bit4    Bit3
                   //Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0 0
                   //0       0       0

/////////////////////////////////

sfr BRT = 0x9c;  //独立波特率发生器重载值Bit7    Bit6    Bit5    Bit4    Bit3
                 //Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                 //0       0       0       0       0
...
sfr ADC_CONTR =
    0xbc;  // ADC控制寄存器         Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           // Bit1    Bit0 位描述            ADC_POWER  SPEED1 SPEED0 ADC_FLAG
           //ADC_START CHS2    CHS1    CHS0 初始值=0000,0000      0       0 0 0
           //0       0       0       0
...
sfr ADC_RES = 0xbd;  // ADC结果高字节         Bit7    Bit6    Bit5    Bit4 Bit3
                     // Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0
                     //0       0       0       0

/////////////////////////////////

sfr ADC_RESL = 0xbe;  // ADC结果低字节         Bit7    Bit6    Bit5    Bit4 Bit3
                      // Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0
                      //0       0       0       0       0

////////////////////////////////////////////////////////////////////////////////////////////////////////////////

sfr IAP_DATA = 0xc2;  // IAP数据寄存器         Bit7    Bit6    Bit5    Bit4 Bit3
                      // Bit2    Bit1    Bit0 初始值=1111,1111      1       1 1
                      //1       1       1       1       1

/////////////////////////////////

sfr IAP_ADDRH = 0xc3;  // IAP地址高位寄存器     Bit7    Bit6    Bit5    Bit4
                       // Bit3    Bit2    Bit1    Bit0 初始值=0000,0000      0 0
                       //0       0       0       0       0       0

/////////////////////////////////

sfr IAP_ADDRL = 0xc4;  // IAP地址低位寄存器     Bit7    Bit6    Bit5    Bit4
                       // Bit3    Bit2    Bit1    Bit0 初始值=0000,0000      0 0
                       //0       0       0       0       0       0

/////////////////////////////////

sfr IAP_CMD = 0xc5;  // IAP命令寄存器         Bit7    Bit6    Bit5    Bit4 Bit3
                     // Bit2    Bit1    Bit0 初始值=xxxx,xx00      x       x x x
                     //x       x       0       0
...
sfr IAP_TRIG = 0xc6;  // IAP命令触发寄存器     Bit7    Bit6    Bit5    Bit4 Bit3
                      // Bit2    Bit1    Bit0 初始值=xxxx,xxxx      x       x x
                      //x       x       x       x       x
...
sfr IAP_CONTR = 0xc7;  // IAP控制寄存器         Bit7    Bit6    Bit5    Bit4
                       // Bit3    Bit2    Bit1    Bit0 位描述 IAPEN   SWBS SWRST
                       //CMD_FAIL -      WT2     WT1     WT0 初始值=0000,0000 0
                       //0       0       0       0       0       0       0
...
sfr SPSTAT = 0xcd;  // SPI状态寄存器         Bit7    Bit6    Bit5    Bit4 Bit3
                    // Bit2    Bit1    Bit0 位描述                SPIF    WCOL -
                    //-       -       -       -       - 初始值=11xx,xxxx      1
                    //1       x       x       x       x       x       x

#define SPIF \
  0x80  // SPI传输完成标志,当SPI中断使能时会触发SPI中断请求,需要用软件向此位写"1"来清0
#define WCOL 0x40  // SPI写冲突标志,需要用软件向此位写"1"来清0

/////////////////////////////////

sfr SPCTL =
    0xce;  // SPI控制寄存器         Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           // Bit1    Bit0 位描述                SSIG    SPEN    DORD    MSTR
           //CPOL    CPHA    SPR1    SPR0 初始值=0000,0100      0       0 0 0 0
           //1       0       0
...
sfr SPDAT = 0xcf;  // SPI数据寄存器         Bit7    Bit6    Bit5    Bit4    Bit3
                   // Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0 0
                   //0       0       0

////////////////////////////////////////////////////////////////////////////////////////////////////////////////

sfr CCON = 0xd8;  // PCA控制寄存器         Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 位描述                CF      CR      -
                  //-       -       -       CCF1    CCF0 初始值=00xx,xx00      0
                  //0       x       x       x       x       0       0

sbit CF =
    CCON ^
    7;  // PCA计数器溢出标志,当PCA中断使能时会触发PCA中断请求,需要用软件清0
...
sfr CMOD = 0xd9;  // PCA模式寄存器         Bit7    Bit6    Bit5    Bit4    Bit3
                  // Bit2    Bit1    Bit0 位描述                CIDL    -       -
                  //-       CPS2    CPS1    CPS0    ECF 初始值=0xxx,0000      0
                  //x       x       x       0       0       0       0

#define CIDL \
  0x80  //计时器阵列空闲控制,0:空闲模式下PCA继续工作 1:空闲模式下PCA停止工作
...
sfr CCAPM0 =
    0xda;  // PCA模块0模式寄存器    Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           // Bit1    Bit0 位描述                -       ECOM0   CAPP0   CAPN0
           //MAT0    TOG0    PWM0    ECCF0 初始值=x000,0000      x       0 0 0
           //0       0       0       0
...
#define PCA0_MAT \
  0x08  //匹配使能,当PCA的计数值与模块0设定的值相匹配时,置CCON.CCF0
#define PCA0_TOG \
  0x04  //翻转控制位,当PCA的计数值与模块0设定的值相匹配时,翻转CEX0的电平
...
sfr CCAPM1 =
    0xdb;  // PCA模块1模式寄存器    Bit7    Bit6    Bit5    Bit4    Bit3    Bit2
           // Bit1    Bit0 位描述                -       ECOM1   CAPP1   CAPN1
           //MAT1    TOG1    PWM1    ECCF1 初始值=x000,0000      x       0 0 0
           //0       0       0       0
...
#define PCA1_MAT \
  0x08  //匹配使能,当PCA的计数值与模块1设定的值相匹配时,置CCON.CCF1
#define PCA1_TOG \
  0x04  //翻转控制位,当PCA的计数值与模块1设定的值相匹配时,翻转CEX1的电平
...
sfr CL = 0xe9;  // PCA计数器低8位        Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                //0       0       0       0       0

/////////////////////////////////

sfr CH = 0xf9;  // PCA计数器高8位        Bit7    Bit6    Bit5    Bit4    Bit3
                // Bit2    Bit1    Bit0 初始值=0000,0000      0       0       0
                //0       0       0       0       0

/////////////////////////////////

sfr CCAP0L = 0xea;  // PCA模块0寄存器低8位   Bit7    Bit6    Bit5    Bit4 Bit3
                    // Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0
                    //0       0       0       0

/////////////////////////////////

sfr CCAP1L = 0xeb;  // PCA模块1寄存器低8位   Bit7    Bit6    Bit5    Bit4 Bit3
                    // Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0
                    //0       0       0       0

/////////////////////////////////

sfr CCAP0H = 0xfa;  // PCA模块0寄存器高8位   Bit7    Bit6    Bit5    Bit4 Bit3
                    // Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0
                    //0       0       0       0

/////////////////////////////////

sfr CCAP1H = 0xfb;  // PCA模块1寄存器高8位   Bit7    Bit6    Bit5    Bit4 Bit3
                    // Bit2    Bit1    Bit0 初始值=0000,0000      0       0 0 0
                    //0       0       0       0

/////////////////////////////////

sfr PCA_PWM0 = 0xf2;  // PCA0模式PWM辅助寄存器 Bit7    Bit6    Bit5    Bit4 Bit3
                      // Bit2    Bit1    Bit0 位描述                -       - -
                      //-       -       -       EPC0H   EPC0L 初始值=xxxx,xx00
                      //x       x       x       x       x       x       0 0

/////////////////////////////////

sfr PCA_PWM1 = 0xf3;  // PCA1模式PWM辅助寄存器 Bit7    Bit6    Bit5    Bit4 Bit3
                      // Bit2    Bit1    Bit0 位描述                -       - -
                      //-       -       -       EPC1H   EPC1L 初始值=xxxx,xx00
                      //x       x       x       x       x       x       0 0
